...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-16 pb-20 lg:pt-24 lg:pb-28">
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-72 bg-brand-50/60 dark:bg-brand-900/10"
        aria-hidden
      />
      ...
      <div className="container-app relative">
        ...
        >
          ...
          <h1 className="text-balance text-[2.6rem] sm:text-5xl lg:text-[3.6rem] font-extrabold leading-[1.05] tracking-tight text-[rgb(var(--fg))]">
          ...
          {/* Recherche intelligente — l'action principale, mise en avant */}
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-[rgb(var(--muted-fg))]">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-x-2 gap-y-1.5 text-xs text-[rgb(var(--muted-fg))]">
